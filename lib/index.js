...
class DiscordDatabase {
   ...
   * @returns {boolean} true if login and token saved
   * @example call - discordDatabase.login('email','password')
   * @description this method is for login to discord and get the token if you have the token you can use the class without login
   */
